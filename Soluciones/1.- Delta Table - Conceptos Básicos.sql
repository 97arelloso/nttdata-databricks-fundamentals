...
CREATE SCHEMA IF NOT EXISTS nttdata_databricks_lab.schema_alejandro;
...
CREATE TABLE IF NOT EXISTS nttdata_databricks_lab.schema_alejandro.departamentos_delta (
    ID INT,
    NAME STRING,
    FLOOR INT
) USING DELTA;
...
INSERT INTO nttdata_databricks_lab.schema_alejandro.departamentos_delta (ID, NAME, FLOOR)
VALUES
    (1, 'Finanzas', 4),
    (2, 'D&A', 23),
    (3, 'RRHH', 2),
...
CREATE TABLE IF NOT EXISTS nttdata_databricks_lab.schema_alejandro.departamentos_external (
    ID INT,
    NAME STRING,
    FLOOR INT
) USING parquet
...
INSERT INTO nttdata_databricks_lab.schema_alejandro.departamentos_external (ID, NAME, FLOOR)
VALUES
    (1, 'Finanzas', 4),
    (2, 'D&A', 23),
    (3, 'RRHH', 2),
...
UPDATE nttdata_databricks_lab.schema_alejandro.departamentos_delta 
SET FLOOR = 1 WHERE ID = 4
...
UPDATE nttdata_databricks_lab.schema_alejandro.departamentos_external 
SET FLOOR = 1 WHERE ID = 4
...
DESCRIBE TABLE EXTENDED nttdata_databricks_lab.schema_alejandro.departamentos_delta

-- COMMAND ----------

DESCRIBE TABLE EXTENDED nttdata_databricks_lab.schema_alejandro.departamentos_external
...
list 's3://databricks-workspace-stack-be532-bucket/unity-catalog/426896731799702/__unitystorage/catalogs/63de764e-e901-4976-8cc3-740a755771cd/tables/8c9f7f60-51f8-4335-8f39-23b83e9ed975'
